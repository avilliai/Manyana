...
| gpt3.5-dev          | 官方gpt3.5，(**先声明，哥们不是打广告的**)从[特定店铺](https://m.tb.cn/h.5DYyOxMMQRO7IjN?tk=wKhKWnllkTI HU0025) 购买的apikey无需代理(他们有中转更稳，                   | openai-keys          | 大概1.8元一个apikey，并且似乎**只有他们店里的apikey能走他们的中转，因此不要在openai-keys里混用其他来源的apikey**，看你自己的需要吧。 |
