...
async def bbbgacha(bbb):
    ...
    character=[]
    pool={'3': ['白子', '星野', '阿露', '伊织', '日奈', '泉', '晴奈', '日富美', '鹤城', '花凛', '尼禄', '真纪', '响', '菫', '纱绫', '瞬', '艾米', '真白', '泉奈', '爱丽丝', '绿', '切里诺', '柚子', '梓', '小春', '梓（泳装）', '真白（泳装）', '日富美（泳装）', '日奈（泳装）', '伊织（泳装）', '白子（骑行）', '瞬（幼女）', '纱绫（私服）', '尼禄（兔女郎）', '花凛（兔女郎）', '明日奈（兔女郎）', '夏', '初音未来（联动）', '亚子', '切里诺（温泉）', '千夏（温泉）', '和香（温泉）', '阿露（正月）', '睦月（正月）', '芹香（正月）', '若藻', '濑名', '千寻', '三森', '日向', '玛丽娜', '咲', '宫子', '美游', '枫', '伊吕波', '月咏', '美咲', '日和', '亚津子', '野宫（泳装）', '若藻（泳装）', '星野（泳装）', '泉奈（泳装）', '千世（泳装）', '纱织', '萌绘', '和纱', '心奈', '歌原（应援团）', '诺亚', '朱音（兔女郎）', '优香（体操服）', '玛丽（体操服）', '日鞠', '时雨', '芹娜（圣诞）', '花绘（圣诞）', '晴奈（正月）', '枫香（正月）', '美祢', '未花', '惠', '康娜', '樱子', '时', '渚', '忧', '小雪', '佳代子（正月）', '遥香（正月）', '果穗', '时（兔女郎）', '爱丽丝（女仆）', '玲纱', '瑠美', '南', '实梨', '宫子（泳装）', '咲（泳装）', '白子（泳装）', '日向（泳装）', '忧（泳装）', '花子（泳装）', '三森（泳装）', '梅露', '柯托莉（应援团）', '晴奈（体操服）', '霞', '一花', '时雨（温泉）', '御坂美琴', '食蜂操祈', '缘里', '莲华', '桔梗','艾米（泳装）'],'2': ['芹香', '绫音', '佳代子', '淳子', '明里', '枫香', '爱莉', '莲见', '朱音', '晴', '歌原', '优香', '椿', '千世', '桃井', '野宫', '花绘', '静子', '花子', '桐乃', '玛丽', '睦月', '红叶'],'1': ['千夏', '好美', '芹娜', '明日奈', '柯托莉', '菲娜', '鹤城（泳装）', '吹雪', '满', '绫音（泳装）', '巴', '静子（泳装）', '和香', '遥香', '泉（泳装）', '朱莉', '志美子', '铃美', '小玉', '响（应援团）', '莲见（体操服）', '淳子（正月）', '柚子（女仆）', '美游（泳装）', '小春（泳装）', '佐天泪子']}
